...
Now, please select or type the project name. Available projects:\n\n{project_list}\n\nOr type 'show all' to see the full list."""
        ...
        if matched_project:
            ...
            result = create_overtime_request(
                employee_id,
                st.session_state.overtime_request['start_datetime'],
                st.session_state.overtime_request['end_datetime'],
                matched_project['id'],
            ...
            st.session_state.overtime_request = {} # Clear session state, flow is done
